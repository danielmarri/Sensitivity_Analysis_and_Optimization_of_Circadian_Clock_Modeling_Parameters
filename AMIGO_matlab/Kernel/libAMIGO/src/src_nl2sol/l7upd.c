/* l7upd.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int l7upd_(real *beta, real *gamma, real *l, real *lambda, 
	real *lplus, integer *n, real *w, real *z__)
{
    ...
    static real lj, wj, nu, zj;
    static integer jp1, nm1, np1;
    static real eta, lij, ljj, theta;
...
/* Computing 2nd power */
	r__1 = a;
	eta = -(eta + r__1 * r__1 / (theta - lj)) / lj;
/* L20: */
    }
L30:
    lambda[*n] = (nu * z__[*n] - eta * w[*n]) * w[*n] + 1.f;
