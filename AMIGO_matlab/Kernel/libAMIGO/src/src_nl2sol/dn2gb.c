/* dn2gb.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int dn2gb_(integer *n, integer *p, doublereal *x, doublereal 
	*b, integer *iv, integer *liv, integer *lv, doublereal *v, integer *uiparm, 
	doublereal *urparm,void* data)
{
	...
	extern int calcr_(integer *, integer *, 
		doublereal *, integer *, doublereal *, integer *, doublereal *, void*);
	
	extern int calcj_(integer *, integer *, doublereal *, integer *, doublereal *,
		integer *, doublereal *, void*);
...
L30:
    nf = iv[6];
    calcr_(n, p, &x[1], &nf, &v[r1], &uiparm[1], &urparm[1], data);
    if (nf > 0) {
	goto L40;
    }
    iv[2] = 1;
...
L50:
    calcj_(n, p, &x[1], &iv[7], &v[dr1], &uiparm[1], &urparm[1], data);
    if (iv[7] == 0) {
		iv[2] = 1;
    }
    goto L20;
