/* parck.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int parck_(integer *alg, real *d__, integer *iv, integer *
	liv, integer *lv, integer *n, real *v)
{
    /* Initialized data */
    ...
    static real vm[34] = { .001f,-.99f,.001f,.01f,1.2f,.01f,1.2f,0.f,0.f,
	    .001f,-1.f,0.0,0.f,0.0,0.f,0.f,0.0,0.0,0.f,-10.f,0.f,0.f,0.f,0.0,
	    0.0,0.0,1.01f,1e10f,0.0,0.f,0.f,0.f,0.0,0.f };
    static real vx[34] = { .9f,-.001f,10.f,.8f,100.f,.8f,100.f,.5f,.5f,1.f,
	    1.f,0.0,0.0,.1f,1.f,1.f,0.0,0.0,1.f,0.0,0.0,0.0,1.f,1.f,1.f,1.f,
	    1e10f,0.0,1.f,0.0,1.f,1.f,1.f,1.f };
    static char varnm[1*2] = "P" "P";
    static char sh[1*2] = "S" "H";

    /* Format strings */
    static char fmt_10[] = "(/\002 THE FIRST PARAMETER TO  IVSET SHOULD B"
    ...
    static char fmt_130[] = "(/\002 ///  \002,2a4,\002.. V(\002,i2,\002) "
	    "=\002,e11.3,\002 SHOULD\002,\002 BE BETWEEN\002,e11.3,\002 AN"
	    "D\002,e11.3)";
    static char fmt_160[] = "(/\002 IV(NVDFLT) =\002,i5,\002 RATHER THAN "
	    "\002,i5)";
    static char fmt_180[] = "(/\002 ///  D(\002,i3,\002) =\002,e11.3,\002 SH"
    ...
    static char fmt_270[] = "(1x,2a4,\002.. V(\002,i2,\002) =\002,e15.7)";
    ...
    extern /* Subroutine */ int v7dfl_(integer *, integer *, real *), v7cpy_(
	    integer *, real *, real *);
...
/* IVSET  -- SUPPLIES DEFAULT VALUES TO BOTH IV AND V. */
/*  R7MDC -- RETURNS MACHINE-DEPENDENT CONSTANTS. */
/* V7CPY  -- COPIES ONE VECTOR TO ANOTHER. */
/* V7DFL  -- SUPPLIES DEFAULT PARAMETER VALUES TO V ALONE. */
...
L120:
	...
	if (pu != 0) {
	    ...
	    do_fio(&c__1, (char *)&vk, (ftnlen)sizeof(real));
	    do_fio(&c__1, (char *)&vm[i__ - 1], (ftnlen)sizeof(real));
...
L250:
	...
	do_fio(&c__1, vn + ((i__ << 1) - 1 << 2), (ftnlen)4);
	do_fio(&c__1, (char *)&k, (ftnlen)sizeof(integer));
	do_fio(&c__1, (char *)&v[k], (ftnlen)sizeof(real));
	e_wsfe();
L280:
	++k;
	++l;
