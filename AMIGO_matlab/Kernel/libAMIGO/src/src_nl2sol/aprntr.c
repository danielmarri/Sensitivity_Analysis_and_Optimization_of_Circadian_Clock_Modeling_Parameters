/* aprntr.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int aprntr_(real *a, integer *nitems, integer *iout, integer 
	*mcol, integer *w, integer *d__)
{
    /* Initialized data */
...
/* /6S */
/*     IF (NITEMS .LE. 0) CALL */
/*    1  SETERR(27H  APRNTR - NITEMS .LE. ZERO, 27, 1, 2) */
/* /7S */
    if (*nitems <= 0) {
	seterr_("  APRNTR - NITEMS .LE. ZERO", &c__27, &c__1, &c__2, (ftnlen)
		27);
    }
/* / */
...
/* /6S */
/*     IF (W .GT. MCOL) CALL */
/*    1  SETERR(22H  APRNTR - W .GT. MCOL, 22, 2, 2) */
/* /7S */
    if (*w > *mcol) {
	seterr_("  APRNTR - W .GT. MCOL", &c__22, &c__2, &c__2, (ftnlen)22);
    }
/* / */

/* /6S */
/*     IF (D .LT. 0) CALL */
/*    1  SETERR(22H  APRNTR - D .LT. ZERO, 22, 3, 2) */
/* /7S */
    if (*d__ < 0) {
	seterr_("  APRNTR - D .LT. ZERO", &c__22, &c__3, &c__2, (ftnlen)22);
    }
/* / */

/* /6S */
/*     IF (W .LT. D+6) CALL */
/*    1  SETERR(21H  APRNTR - W .LT. D+6, 21, 4, 2) */
/* /7S */
    if (*w < *d__ + 6) {
	seterr_("  APRNTR - W .LT. D+6", &c__21, &c__4, &c__2, (ftnlen)21);
    }
/* / */
