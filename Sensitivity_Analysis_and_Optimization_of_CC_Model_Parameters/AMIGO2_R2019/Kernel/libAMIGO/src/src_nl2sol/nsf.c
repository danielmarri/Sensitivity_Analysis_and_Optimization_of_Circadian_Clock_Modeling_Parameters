/* nsf.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int nsf_(integer *n, integer *p, integer *l, real *alf, real 
	*c__, real *y, S_fp calca, integer *inc, integer *iinc, integer *iv, 
	integer *liv, integer *lv, real *v, integer *uiparm, real *urparm, 
	U_fp ufparm)
{
    /* Initialized data */
...
/* L220: */
	...
	iv[1] = -2;
	rnsg_(&v[a1], &alf[1], &c__[1], &v[da1], &iv[in1], &iv[1], l, &l1, n, 
