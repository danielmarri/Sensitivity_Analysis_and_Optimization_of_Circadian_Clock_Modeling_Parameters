/* itsum.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int itsum_(real *d__, real *g, integer *iv, integer *liv, 
	integer *lv, integer *p, real *v, real *x)
{
    /* Initialized data */
    ...
    static char fmt_100[] = "(i6,i5,e10.3,2e9.2,e8.1,a3,a4,2e8.1,e9.2)";
    static char fmt_110[] = "(i6,i5,e11.3,2e10.2,3e9.1,e10.2)";
    ...
    static char fmt_400[] = "(/\002     I     INITIAL X(I)\002,8x,\002D(I"
	    ")\002//(1x,i5,e17.6,e14.3))";
    static char fmt_410[] = "(/\002     0\002,i5,e10.3)";
    static char fmt_420[] = "(/\002     0\002,i5,e11.3)";
    static char fmt_450[] = "(/\002 FUNCTION\002,e17.6,\002   RELDX\002,e17."
	    "3/\002 FUNC. EVALS\002,i8,9x,\002GRAD. EVALS\002,i8/\002 PRELD"
	    "F\002,e16.3,6x,\002NPRELDF\002,e15.3)";
    static char fmt_470[] = "(/\002     I      FINAL X(I)\002,8x,\002D(I)"
	    "\002,10x,\002G(I)\002/)";
    static char fmt_490[] = "(1x,i5,e16.6,2e14.3)";
    ...
    static real oldf, reldf, nreldf, preldf;
...
/*        ***  PRINT SHORT SUMMARY LINE  *** */
    ...
    do_fio(&c__1, (char *)&v[10], (ftnlen)sizeof(real));
    do_fio(&c__1, (char *)&reldf, (ftnlen)sizeof(real));
    do_fio(&c__1, (char *)&preldf, (ftnlen)sizeof(real));
    do_fio(&c__1, (char *)&v[17], (ftnlen)sizeof(real));
    do_fio(&c__1, model1 + (m - 1 << 2), (ftnlen)4);
    do_fio(&c__1, model2 + (m - 1 << 2), (ftnlen)4);
    do_fio(&c__1, (char *)&v[5], (ftnlen)sizeof(real));
    e_wsfe();
    goto L120;
...
L60:
    ...
    do_fio(&c__1, model2 + (m - 1 << 2), (ftnlen)4);
    do_fio(&c__1, (char *)&v[5], (ftnlen)sizeof(real));
    do_fio(&c__1, (char *)&v[2], (ftnlen)sizeof(real));
    do_fio(&c__1, (char *)&nreldf, (ftnlen)sizeof(real));
    e_wsfe();
    goto L120;
