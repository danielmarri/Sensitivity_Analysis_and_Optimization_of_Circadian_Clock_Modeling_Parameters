/* stkdmp.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int stkdmp_(void)
{
    ...
    /* Local variables */
    static integer i__, dd, dr, wd, wi, wr, lng[5];
...
#define lout ((integer *)&cstak_1)
    ...
    extern /* Subroutine */ int u9dmp_(integer *, integer *, integer *, 
...
#define rstak ((real *)&cstak_1)
    ...
    extern /* Subroutine */ int a9rntc_(complex *, integer *, integer *, 
	    ...
	    integer *, integer *, integer *, integer *), frmatd_(integer *, 
	    integer *);
#define cmstak ((complex *)&cstak_1)
    extern /* Subroutine */ int frmati_(integer *), frmatr_(integer *, 
	    integer *);
    static integer nitems, errout;
...
/*  HAVE BEEN OVERWRITTEN), AND DO AN UNFORMATTED DUMP, AND RETURN. */
    ...
    for (i__ = 1; i__ <= 5; ++i__) {
	lng[i__ - 1] = (bpntr * isize[1] - 1) / isize[i__ - 1] + 1;
/* L30: */
    }
