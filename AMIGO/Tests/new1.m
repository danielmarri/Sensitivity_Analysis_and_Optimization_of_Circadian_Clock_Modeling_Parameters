function dydt = new1(t,y,values)
dydt = zeros(23,1); 

%%
vPs=values(1);       Kpco=values(16);
vCs=values(2);       kcbpc=values(17);
vBs=values(3);       dclbn=values(18);
vRs=values(4);       dpcn=values(19);
vRes=values(5);      kdcbpc = values(20);
k =values(6);        %d_mP=values(21);
k1 =values(7);       %d_mP=values(22);
k2 =values(8);       %d_mP=values(23);
k3=values(9);        %d_mP=values(24);
k4=values(10);       %d_mP=values(25);
d_mP=values(11);
d_mC=values(12);
d_mB=values(13);
d_mR=values(14);
...
%vRes= 2.14; d_mRe = 0.382;   

kiRe = 0.25;   

%k =0.408; Kpco =0.3;

Kpc1=0.362;    Kpc=0.304; Kppc= 0.39; dpc=0.23;
