/* aprntl.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int aprntl_(logical *a, integer *nitems, integer *iout, 
	integer *mcol)
{
    /* Initialized data */
...
/* /6S */
/*     INTEGER  IFMT1(20), IFMT1C(20), IFMT2(19), IFMT2C(19) */
/*     EQUIVALENCE (IFMT1(1),IFMT1C(1)), (IFMT2(1),IFMT2C(1)) */
/*     INTEGER  BLANK, FCHAR, STAR, TCHAR */
/* /7S */
/* / */
/* /6S */
...
/* /6S */
/*     IF (NITEMS .LE. 0) CALL */
/*    1  SETERR(27H  APRNTL - NITEMS .LE. ZERO, 27, 1, 2) */
/* /7S */
    if (*nitems <= 0) {
	seterr_("  APRNTL - NITEMS .LE. ZERO", &c__27, &c__1, &c__2, (ftnlen)
		27);
    }
/* / */
