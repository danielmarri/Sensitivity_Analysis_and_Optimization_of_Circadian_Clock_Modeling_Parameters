/* dnsfb.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int dnsfb_(integer *n, integer *p, integer *l, doublereal *
	alf, doublereal *b, doublereal *c__, doublereal *y, S_fp calca, 
	integer *inc, integer *iinc, integer *iv, integer *liv, integer *lv, 
...
/*     DOUBLE PRECISION ALF(P), C(L), B(2,P), URPARM(1), V(LV), Y(N) */
/* /7 */
/* / */
