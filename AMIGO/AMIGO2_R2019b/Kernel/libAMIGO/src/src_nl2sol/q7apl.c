/* q7apl.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int q7apl_(integer *nn, integer *n, integer *p, real *j, 
...
/*      D7TPR - FUNCTION, RETURNS THE INNER PRODUCT OF VECTORS */
...
/*     CALL ON V2AXY SUBSTITUTED FOR DO LOOP, FALL 1983. */
...
/*  ***  BODY  *** */
    ...
    for (l = 1; l <= i__1; ++l) {
	nl1 = *n - l + 1;
	r__1 = -d7tpr_(&nl1, &j[l + l * j_dim1], &r__[l]);
	v2axy_(&nl1, &r__[l], &r__1, &j[l + l * j_dim1], &r__[l]);
/* L20: */
    }

L999:
    return 0;
/*  ***  LAST LINE OF  Q7APL FOLLOWS  *** */
} /* q7apl_ */
