/* n2cvp.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int n2cvp_(integer *iv, integer *liv, integer *lv, integer *
	p, real *v)
{
    /* Format strings */
    ...
    static char fmt_180[] = "(\002 ROW\002,i3,2x,5e12.3/(9x,5e12.3))";
...
/*  ***  PRINT COVARIANCE MATRIX FOR   RN2G  *** */
...
L130:
	...
	i__2 = ii;
	for (j = i1; j <= i__2; ++j) {
	    do_fio(&c__1, (char *)&v[j], (ftnlen)sizeof(real));
	}
	e_wsfe();
/* L170: */
    }
