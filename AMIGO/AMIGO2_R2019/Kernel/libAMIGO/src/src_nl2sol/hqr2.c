/* hqr2.f -- translated by f2c (version 20100827).
...
/*     CALLS ON CDIV REPLACED BY COMPLEX DIVISION. */
...
L720:
	...
	q__3.r = r__2, q__3.i = q;
	c_div(&q__1, &q__2, &q__3);
	z3.r = q__1.r, z3.i = q__1.i;
	h__[na + na * h_dim1] = z3.r;
	h__[na + en * h_dim1] = r_imag(&z3);
L730:
...
L770:
	    ...
	    c_div(&q__1, &q__2, &q__3);
	    z3.r = q__1.r, z3.i = q__1.i;
	    h__[i__ + na * h_dim1] = z3.r;
	    h__[i__ + en * h_dim1] = r_imag(&z3);
	    goto L790;
...
L785:
	    ...
	    c_div(&q__1, &q__2, &q__3);
	    z3.r = q__1.r, z3.i = q__1.i;
	    h__[i__ + 1 + na * h_dim1] = z3.r;
	    h__[i__ + 1 + en * h_dim1] = r_imag(&z3);
