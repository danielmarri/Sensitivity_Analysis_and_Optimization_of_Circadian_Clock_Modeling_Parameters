/* d0xtrp.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int d0xtrp_(doublereal *tm, integer *m, integer *nvar, 
	doublereal *ng, integer *kmax, logical *xpoly, doublereal *t, real *
	error, real *ebest, doublereal *rhg, real *emag, logical *esave)
{
