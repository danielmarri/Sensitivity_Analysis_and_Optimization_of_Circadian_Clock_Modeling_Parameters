/* n2rdp.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int n2rdp_(integer *iv, integer *liv, integer *lv, integer *
	n, real *rd, real *v)
{
    /* Format strings */
    static char fmt_20[] = "(/\002 REGRESSION DIAGNOSTIC = SQRT( G(I)**T * H"
	    "(I)**-1 * G(I) / ABS(F) )...\002/(6e12.3))";
...
L10:
    ...
    s_wsfe(&io___2);
    i__1 = 1 * rd_dim1;
    do_fio(&i__1, (char *)&rd[1], (ftnlen)sizeof(real));
    e_wsfe();
    goto L999;
L30:
    io___3.ciunit = pu;
