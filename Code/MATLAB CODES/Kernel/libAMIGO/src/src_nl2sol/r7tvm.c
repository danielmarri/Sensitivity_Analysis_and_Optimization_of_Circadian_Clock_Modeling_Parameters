/* r7tvm.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int r7tvm_(integer *n, integer *p, real *y, real *d__, real *
	u, real *x)
{
...
/*  ***  BODY  *** */
	...
	if (i__ > 1) {
	    i__2 = i__ - 1;
	    t += d7tpr_(&i__2, &u[i__ * u_dim1 + 1], &x[1]);
	}
	y[i__] = t;
/* L10: */
    }
