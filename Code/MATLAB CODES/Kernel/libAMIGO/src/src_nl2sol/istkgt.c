/* istkgt.f -- translated by f2c (version 20100827).
...
integer istkgt_(integer *nitems, integer *itype)
{
    /* Initialized data */
...
/* /7S */
    if (*nitems < 0) {
	seterr_("ISTKGT - NITEMS.LT.0", &c__20, &c__1, &c__2, (ftnlen)20);
    }
/* / */
...
/* / */
    ...
    i__ = ((ret_val - 1 + *nitems) * isize[*itype - 1] - 1) / isize[1] + 3;
...
/* /7S */
	...
	seterr_("ISTKGT - STACK TOO SHORT. ENLARGE IT AND CALL ISTKIN IN MAI"
		"N PROGRAM.", &c__69, &c__4, &c__2, (ftnlen)69);
    }
/* / */
