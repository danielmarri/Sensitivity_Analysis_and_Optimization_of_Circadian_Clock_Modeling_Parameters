/* dorthe.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int dorthe_(integer *nm, integer *n, integer *low, integer *
...
/*     EISPACK SINGLE-PRECISION ROUTINE ORTHES. */
/*     IT WAS ADAPTED BY PHYLLIS FOX, MAY 28, 1975. */

/*     ORTHES IS A TRANSLATION OF THE ALGOL PROCEDURE ORTHES, */
/*     NUM. MATH. 12, 349-368(1968) BY MARTIN AND WILKINSON. */
/*     HANDBOOK FOR AUTO. COMP., VOL.II-LINEAR ALGEBRA, 339-358(1971). */

/*     GIVEN A REAL (DOUBLE PRECISION) GENERAL MATRIX, THIS SUBROUTINE */
