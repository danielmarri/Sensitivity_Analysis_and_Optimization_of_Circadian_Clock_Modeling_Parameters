/* ortra.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int ortra_(integer *nm, integer *n, integer *low, integer *
...
/*     THIS IS THE EISPACK ROUTINE, ORTRAN, PUT INTO PORT */
/*     AUGUST 18, 1976. */

/*     THE NAME CHANGE IS DUE TO THE PORT CONVENTION THAT ALL DOUBLE */
/*     PRECISION NAMES HAVE A D PUT IN FRONT OF THE SINGLE- */
/*     PRECISION ONES, WHICH THEREFORE CAN HAVE ONLY 5 CHARACTERS. */
...
/*   MATRIX TO UPPER HESSENBERG FORM BY ORTHE. */
...
/*          FORMATIONS USED IN THE REDUCTION BY ORTHE */
...
/*     ********** DIVISOR BELOW IS NEGATIVE OF H FORMED IN ORTHE. */
