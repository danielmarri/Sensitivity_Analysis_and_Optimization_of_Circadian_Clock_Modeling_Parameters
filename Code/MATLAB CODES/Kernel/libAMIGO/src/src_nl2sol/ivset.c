/* ivset.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int ivset_(integer *alg, integer *iv, integer *liv, integer *
	lv, real *v)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int v7dfl_(integer *, integer *, real *);
...
/* V7DFL.... PROVIDES DEFAULT VALUES TO V. */
