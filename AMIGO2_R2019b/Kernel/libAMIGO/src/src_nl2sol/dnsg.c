/* dnsg.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int dnsg_(integer *n, integer *p, integer *l, doublereal *
	alf, doublereal *c__, doublereal *y, S_fp calca, S_fp calcb, integer *
	inc, integer *iinc, integer *iv, integer *liv, integer *lv, 
...
/* T(1)...T(N),   DNSG ATTEMPTS TO COMPUTE A LEAST SQUARES FIT */
...
/*                      OF IV AND V BEFORE CALLING   DNSG. */
