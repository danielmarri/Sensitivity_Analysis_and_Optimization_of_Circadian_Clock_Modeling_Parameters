/* deigen.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int deigen_(integer *nm, integer *n, doublereal *a, 
	doublereal *wr, doublereal *wi, doublereal *z__)
{
    ...
    extern /* Subroutine */ int dhqr2_(integer *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
	     integer *), dorthe_(integer *, integer *, integer *, integer *, 
	    doublereal *, doublereal *), dortra_(integer *, integer *, 
...
/* DEIGEN FINDS THE EIGENVALUES AND EIGENVECTORS */
/* OF A DOUBLE-PRECISION MATRIX (NOT IMAGINARY) BY */
/* CALLING THE SEQUENCE OF SUBROUTINES */
/* DORTHE,DORTRA, AND DHQR2, WHICH, IN TURN, ARE */
/* THE EISPACK ROUTINES ORTHES, ORTRAN, AND HQR2, */
/* ADJUSTED FOR DOUBLE PRECISION. */
...
/*   A - THE MATRIX, A DOUBLE-PRECISION TWO-DIMENSIONAL */
...
/*   WR - A DOUBLE-PRECISION ARRAY OF DIMENSION */
/*        AT LEAST N CONTAINING THE REAL PARTS OF THE EIGENVALUES */

/*   WI - A DOUBLE-PRECISION ARRAY OF DIMENSION */
...
/*   Z - A DOUBLE-PRECISION TWO-DIMENSIONAL ARRAY */
...
/* /7S */
    ...
    /* Function Body */
    if (*n > *nm) {
	seterr_("DEIGEN - N IS GREATER THAN NM", &c__29, &c__1, &c__2, (
		ftnlen)29);
    }
/* / */
...
/* ALLOCATE A SCRATCH VECTOR */
    ...
    dorthe_(nm, n, &c__1, n, &a[a_offset], &cstak_1.d__[iort - 1]);
    dortra_(nm, n, &c__1, n, &a[a_offset], &cstak_1.d__[iort - 1], &z__[
	    z_offset]);
    dhqr2_(nm, n, &c__1, n, &a[a_offset], &wr[1], &wi[1], &z__[z_offset], &
	    ierr);
...
/* /7S */
L10:
    seterr_("DEIGEN - FAILED ON THAT EIGENVALUE", &c__34, &ierr, &c__1, (
	    ftnlen)34);
/* / */
