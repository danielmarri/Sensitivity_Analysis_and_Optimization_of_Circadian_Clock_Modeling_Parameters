/* a9rntd.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int a9rntd_(doublereal *a, integer *nitems, integer *iout, 
...
/*  THIS IS THE DOCUMENTED ROUTINE APRNTD, BUT WITHOUT THE CALLS TO */
