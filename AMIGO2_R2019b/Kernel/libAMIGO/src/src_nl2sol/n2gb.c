/* n2gb.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int n2gb_(integer *n, integer *p, real *x, real *b, S_fp 
	calcr, S_fp calcj, integer *iv, integer *liv, integer *lv, real *v, 
	integer *uiparm, real *urparm, U_fp ufparm)
{
    ...
    extern /* Subroutine */ int rn2gb_(real *, real *, real *, integer *, 
	    ...
	    integer *, real *, real *, real *, real *), ivset_(integer *, 
...
/*     IF NOT, THEN   N2GB RETURNS WITH IV(1) = 15.  WHEN   N2GB */
...
/*     THEN   N2GB RETURNS WITH IV(1) = 16.  WHEN   N2GB RETURNS, THE */
...
/*     SETS IV(1) TO 15 OR 16.  CALLING   N2GB WITH IV(1) = 0 CAUSES ALL */
/*     DEFAULT VALUES TO BE USED FOR THE INPUT COMPONENTS OF IV AND V. */
/*        IF YOU FIRST CALL IVSET, THEN SET IV(1) TO 13 AND CALL   N2GB, */
...
/*     ARE LARGE ENOUGH.  IF SO, THEN   N2GB RETURNS WITH IV(1) = 14. */
/*     WHEN CALLED WITH IV(1) = 14,   N2GB ASSUMES THAT STORAGE HAS */
