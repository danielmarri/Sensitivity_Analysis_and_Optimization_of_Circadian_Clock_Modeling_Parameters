/* s1mach.f -- translated by f2c (version 20100827).
...
static real c_b192 = 1.f;
static doublereal c_b273 = 1.;

/* Subroutine */ int s1mach_(void)
{
    /* Initialized data */

    static char ccplus[1] = "+";
    static struct {
	char e_1[12];
	} equiv_0 = { "(A1,51X,I  )" };
    ...
    static doublereal xd, yd;
    static real xr, yr;
#define dfmt ((char *)&equiv_2)
#define efmt ((char *)&equiv_1)
    extern integer iflr_(real *);
...
#define digsp (equiv_6 + 10)
    ...
    extern doublereal r1mach_(integer *), s2mach_(real *, integer *, integer *
	    );
    extern doublereal s3mach_(doublereal *, integer *, integer *);
    static doublereal dbasem;
...
/*  FETCH ALL CONSTANTS INTO LOCAL ARRAYS */
	...
	imach[i__ - 1] = i1mach_(&i__);
/* L10: */
    }

    for (i__ = 1; i__ <= 5; ++i__) {
	rmach[i__ - 1] = r1mach_(&i__);
	dmach[i__ - 1] = d1mach_(&i__);
/* L20: */
    }
...
/* /7S */
    s88fmt_(&c__2, &wwidth, ifmt1 + 9, (ftnlen)1);
    io___17.ciunit = *stdout;
    s_wsfe(&io___17);
    for (i__ = 9; i__ <= 11; ++i__) {
	do_fio(&c__1, ifmt1 + (i__ - 1), (ftnlen)1);
    }
    e_wsfe();
/* / */
...
/* /7S */
    s88fmt_(&c__2, &dwidth, efmt1 + 12, (ftnlen)1);
/* / */
    r__2 = (real) imach[9];
...
/* /7S */
    s88fmt_(&c__2, &wwidth, efmt1 + 9, (ftnlen)1);
    io___54.ciunit = *stdout;
    s_wsfe(&io___54);
    for (i__ = 9; i__ <= 14; ++i__) {
	do_fio(&c__1, efmt1 + (i__ - 1), (ftnlen)1);
    }
    e_wsfe();
/* / */
...
/* /7S */
    i__1 = wwidth + 1;
    s88fmt_(&c__2, &i__1, efmt1 + 9, (ftnlen)1);
    i__1 = dwidth + 1;
    s88fmt_(&c__2, &i__1, efmt1 + 12, (ftnlen)1);
/* / */
/*  COMPUTE THE NUMBER OF CHARACTER POSITIONS NEEDED FOR WRITING */
...
/* /7S */
    s88fmt_(&c__2, &dwidth, dfmt1 + 12, (ftnlen)1);
/* / */
    r__2 = (real) imach[9];
...
/* /7S */
    s88fmt_(&c__2, &wwidth, dfmt1 + 9, (ftnlen)1);
    io___65.ciunit = *stdout;
    s_wsfe(&io___65);
    for (i__ = 9; i__ <= 14; ++i__) {
	do_fio(&c__1, dfmt1 + (i__ - 1), (ftnlen)1);
    }
    e_wsfe();
/* / */
...
/* /7S */
    i__1 = wwidth + 1;
    s88fmt_(&c__2, &i__1, dfmt1 + 9, (ftnlen)1);
    i__1 = dwidth + 1;
    s88fmt_(&c__2, &i__1, dfmt1 + 12, (ftnlen)1);
/* / */
/*  NOW CHECK CONSISTENCY OF INTEGER CONSTANTS */
/* /6S */
/*     CALL S88FMT( 2, 14, IFMT(5) ) */
/* /7S */
    s88fmt_(&c__2, &c__14, ifmt1 + 4, (ftnlen)1);
/* / */
...
/* /7S */
    s88fmt_(&c__2, &c__19, efmt1 + 4, (ftnlen)1);
/* / */
    i__1 = imach[11] - 1;
...
/* /7S */
    s88fmt_(&c__2, &c__19, dfmt1 + 4, (ftnlen)1);
/* / */
    i__1 = imach[14] - 1;
