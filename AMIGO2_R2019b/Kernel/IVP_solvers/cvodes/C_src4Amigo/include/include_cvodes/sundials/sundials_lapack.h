 ...
 */
	...
	#define dcopy_f77       dcopy
	#define dscal_f77       dscal
	#define dgemv_f77       dgemv
	#define dtrsv_f77       dtrsv
	#define dsyrk_f77       dsyrk

	#define dgbtrf_f77      dgbtrf
	#define dgbtrs_f77      dgbtrs
	#define dgeqp3_f77      dgeqp3
	#define dgeqrf_f77      dgeqrf
	#define dgetrf_f77      dgetrf
	#define dgetrs_f77      dgetrs
	#define dormqr_f77      dormqr
	#define dpotrf_f77      dpotrf
	#define dpotrs_f77      dpotrs
